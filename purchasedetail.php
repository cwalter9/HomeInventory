...
<script language="javascript" src="purchasedetail.js.php"></script>
...
<tr>
	<td>P.O. No.: </td>
	<td><input type="text" size="20" maxlength="20" name="pono" value="<?=$record["pono"]?>" class="readonly" readonly></td>
	<td>Date : </td>
...
<tr>
	<td>Supplier : </td>
	<td colspan="3"><input type="text" size="80" maxlength="100" name="supplier" value="<?=$record["supplier"]?>"></td>
</tr>
<tr>
	<td>Total Amount : </td>
...
<tr>
	...
	<td>Unit Pirce: </td>
	<td><input type="text" size="10" maxlength="10" name="unitprice" value="" onkeyup="setUnitCost()"></td>
</tr>
</table>
</form>
