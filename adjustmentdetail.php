...
<script language="javascript" src="adjustmentdetail.js.php"></script>
...
<tr>
	<td>Adj. No.: </td>
	<td><input type="text" size="20" maxlength="20" name="stockadjno" value="<?=$record["stockadjno"]?>" class="readonly" readonly></td>
	<td>Type:</td>
	<td>
	<select name="adjtype">
<?
...
<tr>
	<td>Remark : </td>
	<td colspan="5"><input type="text" size="80" maxlength="100" name="remark" value="<?=$record["remark"]?>"></td>
</tr>
<tr>
	<td>Item No. (F2): </td>
	<td colspan="3"><input type="text" size="20" maxlength="20" name="itemno" value="<?=$_REQUEST["itemno"]?>" onkeypress="onItemKeyPress()" onkeyup="onItemKeyUp()">
